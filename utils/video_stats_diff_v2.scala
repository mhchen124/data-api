...
val diffed2 = joined.select((statsNew("value")-statsOld("value")).as('value), statsOld("value").as('old_value), statsNew("value").as('new_value), statsOld("id"), statsOld("sys_time"))
diffed2.rdd.saveAsTextFile(s3OutputPath + "debug_diffed")
